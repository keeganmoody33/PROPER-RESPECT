...
const child = spawn(process.execPath, ["dist/browser-fixture.mjs"], { cwd: packageRoot, stdio: "inherit", env: { ...process.env, PROPER_RESPECT_LOCAL_MCP: "1", PUBLIC_SITE_ORIGIN: "https://proper-respect.com" } });
