...
> **Status correction — 2026-09-20:** Automatic personal archiving on vendor shutdown is superseded. Vendor status and owner relationship remain separate; only the owner changes their lifecycle state. See [release gaps #24](https://github.com/keeganmoody33/PROPER-RESPECT/issues/24) and the [Phase 0/Devin receipt](../verification/2026-09-20-devin-triage-and-phase0-closure.md).
