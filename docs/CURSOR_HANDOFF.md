...
no longer share the first hostname label as a slug. Derived identities key on
the full hostname so discovery review keeps them distinct. Catalog matches are
unchanged. See
