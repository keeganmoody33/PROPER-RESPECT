  ...
  cards: [
    {
      ...
      // Synthetic display fixture, not the owner's bill.
      cost: { amount: 12.34, currency: "USD", cadence: "MONTHLY", basis: "ESTIMATE", asOf: "2026-07-26" },
      activity: {
        ...
        period: { start: "2026-07-20", end: "2026-07-26", label: "Fixture week" },
        total: 523,
